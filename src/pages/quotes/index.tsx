 ...
 * Quotes Index Page
 * 
 * This is the main quotes listing page that displays quotes in either table or card view.
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="rounded-lg border border-red-200 bg-red-50 p-8 text-center dark:border-red-700 dark:bg-red-900/20">
          <h2 className="mb-2 text-xl font-bold text-red-800 dark:text-red-200">Error Loading Quotes</h2>
